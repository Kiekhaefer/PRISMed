...
@RestController
@RequestMapping("/api/pris-med-kafka")
public class PrisMedKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PrisMedKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PrisMedKafkaResource(KafkaProperties kafkaProperties) {
